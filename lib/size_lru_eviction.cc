...
unsigned long long SizeLRUEviction::put(string key, unsigned long data, unsigned long timestamp, unsigned long bytes_out, string customer_id, string orig_url)
{
    SizeLRUEvictionEntry* node = _mapping[key];
    if(node)
    {
